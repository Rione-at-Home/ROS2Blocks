...
public class Workspace extends Pane {
    ...
    public Workspace() {
        ...
        trashCan.setLayoutY(500); // Fixed position near base layout
        ...
        // Capture release global hooks for garbage tracking collection arrays
    ...
    public void removeBlockChain(DraggableBlock block) {
        ...
        // Recursively wipe target chain arrays linked below node element target
